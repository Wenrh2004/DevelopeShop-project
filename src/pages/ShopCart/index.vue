            ...
            <ul class="cart-list" v-for="shopCart in shopCartList" :key="shopCart.id">
              ...
              <li class="cart-list-con5">
                <a href="javascript:void(0)" class="mins"
                  @click="changeCartNum(shopCart, true, -1, $event, shopCart.skuNum)">-</a>
                <input autocomplete="off" type="text" :value="shopCart.skuNum"
                  @change="changeCartNum(shopCart, false, $event.target.value * 1, $event, shopCart.skuNum)" minnum="1"
                  class="itxt" />
