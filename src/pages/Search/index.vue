  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <!--selector-->
        <SearchSelector :setTrademark="setTrademark" :setOptionProps="setOptionProps"></SearchSelector>
        <!--details-->
        <div class="details clearfix">
              ...
              <ul class="sui-nav">
                <li :class="{ active: orderInfo[0] === '1' }">
                  <a href="javascript:;" @click="orderProduct('1')">
                    综合
                    <i v-show="orderInfo[0] === '1'" class="iconfont"
                      :class="orderInfo[1] === 'desc' ? 'icon-down' : 'icon-up'"></i>
                  </a>
                </li>
                <li :class="{ active: orderInfo[0] === '3' }">
                  <a href="javascript:;">
                    销量
                    <i v-show="orderInfo[0] === '3'" class="iconfont"
                      :class="orderInfo[1] === 'desc' ? 'icon-down' : 'icon-up'"></i>
                  </a>
                </li>
                <li :class="{ active: orderInfo[0] === '4' }">
                  <a href="javascript:;">
                    新品
                    <i v-show="orderInfo[0] === '4'" class="iconfont"
                      :class="orderInfo[1] === 'desc' ? 'icon-down' : 'icon-up'"></i>
                  </a>
                </li>
                <li :class="{ active: orderInfo[0] === '5' }">
                  <a href="javascript:;">
                    评价
                    <i v-show="orderInfo[0] === '5'" class="iconfont"
                      :class="orderInfo[1] === 'desc' ? 'icon-down' : 'icon-up'"></i>
                  </a>
                </li>
                <li :class="{ active: orderInfo[0] === '2' }">
                  <a href="javascript:;" @click="orderProduct('2')">
                    价格
                    <i v-show="orderInfo[0] === '2'" class="iconfont"
                      :class="orderInfo[1] === 'desc' ? 'icon-down' : 'icon-up'"></i>
                  </a>
                </li>
              </ul>
            ...
            <ul class="yui3-g" @click="addCart($event)">
              <li class="yui3-u-1-5" v-for="item in goodsList" :key="item.id" :data-id="item.id">
                <div class="list-wrap">
                  ...
                  <div class="operate">
                    <a href="javascript:;" class="sui-btn btn-bordered btn-danger" data-add="1">加入购物车</a>
          ...
          <!-- 分页器 -->
          <MyPagination :currentPage="options.pageNo" :total="totalPage" :showPageNo="5" :pageSize="options.pageSize"
