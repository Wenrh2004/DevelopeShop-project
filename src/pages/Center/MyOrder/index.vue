  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="shopInfo in records" :key="shopInfo.id">
          ...
          <thead>
            <tr>
              <th colspan="5">
                <span class="ordertitle">{{ shopInfo.createTime }}　订单编号：{{ shopInfo.outTradeNo }}
      ...
      <div class="choose-order">
        ...
        <el-pagination :total="total" :current-page="page" layout="prev,pager,next,jumper,->,sizes,total"
          :page-size="limit" :page-sizes="[3, 6, 9, 12]" :pager-count="7" @current-change="getMyOrderInfo"
          @size-change="changeLimitSize"></el-pagination>
